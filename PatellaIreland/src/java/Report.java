...
public class Report extends HttpServlet 
{
    ...
    public void init() throws ServletException 
    {
        ...
        try 
        {
            ...
            stat.execute("CREATE TABLE IF NOT EXISTS report "
                    + "(report_id INT(8) UNIQUE, subject VARCHAR(40), page INT(5) )");
            ...
            throws ServletException, IOException 
    {
        ...
        report_id = Integer.parseInt(request.getParameter("report_id"));
        ...
        try 
        {
            ...
            prepStat.setInt(1, report_id);
            prepStat.setString(2, subject);
            prepStat.setInt(3, page);
